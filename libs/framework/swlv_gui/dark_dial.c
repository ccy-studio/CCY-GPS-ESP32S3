...
static void create_battery_bar() {
    ...
    lv_obj_set_style_bg_color(bar_battery, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(bar_battery, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    lv_obj_set_style_radius(bar_battery, 0, LV_PART_INDICATOR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(bar_battery, lv_color_hex(0x30BA58), LV_PART_INDICATOR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(bar_battery, 255, LV_PART_INDICATOR | LV_STATE_DEFAULT);
}
...
static void on_create_fun(ui_data_t* ui_dat, void* params) {
    ...
    lv_obj_set_style_bg_img_src(page_view, "S:/img/dark-dial.bin", LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(text_current_time, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(text_current_time, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(text_current_time, &font_douyin_16, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(text_battery, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(text_battery, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(text_battery, &font_douyin_12, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_align(text_current_speed, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_x(text_current_speed, 10);
    lv_obj_set_y(text_current_speed, 29);
    lv_label_set_text(text_current_speed, "-");
    lv_obj_set_style_text_color(text_current_speed, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(text_current_speed, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(text_current_speed, &font_digital_num, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(text_kms, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(text_kms, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(text_kms, &font_dignumber16, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(text_run_timeinfo, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(text_run_timeinfo, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(text_run_timeinfo, &font_douyin_16, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(text_speed_max, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(text_speed_max, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(text_speed_max, &font_douyin_12, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(text_speed_avg, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(text_speed_avg, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(text_speed_avg, &font_douyin_12, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(text_speed_sum, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(text_speed_sum, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(text_speed_sum, &font_douyin_12, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(text_sensor_temp, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(text_sensor_temp, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(text_sensor_temp, &font_douyin_12, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(text_sensor_humidity, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(text_sensor_humidity, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(text_sensor_humidity, &font_douyin_12, LV_PART_MAIN | LV_STATE_DEFAULT);
...
static void on_event_data_change(void* sub, bus_msg_t* msg) {
    ...
    //时间
    lv_label_set_text_fmt(text_current_time, "%02d:%02d", dat->curr_gps.datetime.hour, dat->curr_gps.datetime.minute);
    //GPS图标
    ...
    if (dat->is_start) {
        //设置骑行时间
        lv_label_set_text(text_run_timeinfo, format_time(dat->curr_log_dat.run_second));
        if (dat->curr_log_dat.max_speed < speed_kmh) {
            dat->curr_log_dat.max_speed = speed_kmh;
        }
        lv_label_set_text_fmt(text_speed_max, "最大(Max): %dkm/h", dat->curr_log_dat.max_speed);
        //平均速度计算
        if (dat->curr_gps.speed > 1) {
            dat->tick_gps_cnt += 1;
            dat->speed_sum += dat->curr_gps.speed;
            if (dat->tick_gps_cnt % 10 == 0) {
                uint16_t avg_speed = roundf((dat->speed_sum / dat->tick_gps_cnt) * 3.6);
...
static void on_event_battery(void* sub, bus_msg_t* msg) {
    ...
    if (battery->is_charge) {
        ...
        if (battery->level < 20) {
            lv_obj_set_style_text_color(text_battery, lv_color_hex(0xde1c31), 0);
            lv_obj_set_style_bg_color(bar_battery, lv_color_hex(0xde1c31), LV_PART_INDICATOR | LV_STATE_DEFAULT);
        } else {
            lv_obj_set_style_text_color(text_battery, lv_color_white(), 0);
            lv_obj_set_style_bg_color(bar_battery, lv_color_hex(0x3170a7), LV_PART_INDICATOR | LV_STATE_DEFAULT);
        }
    }
...
static void on_event_button(void* sub, bus_msg_t* msg) {
    ...
    if (key->btn_code == APP_BUTTON_UP && key->btn_state == APP_BUTTON_LONG_PRESS) {
#ifndef APP_TEST
        if (current_real_record.is_start) {
            return;
    }
...
static void on_start_fun(void* params) {
    bus_data_change = bus_register_subscribe(DATA_BUS_RECORD_CHANGE, on_event_data_change, NULL);
    bus_battery = bus_register_subscribe(DATA_BUS_BATTERY_EVENT, on_event_battery, NULL);
    bus_env_change = bus_register_subscribe(DATA_BUS_ENV_REFRESH, on_event_env_change, NULL);
    bus_record_start = bus_register_subscribe(DATA_BUS_RECORD_START, on_event_record_start, NULL);
    bus_record_stop = bus_register_subscribe(DATA_BUS_RECORD_STOP, on_event_record_stop, NULL);
    bus_button = bus_register_subscribe(DATA_BUS_BUTTON_EVENT, on_event_button, NULL);
}


ui_data_t dark_dial = {
    .id = ACTIVITY_ID_DIAL_DARK,
